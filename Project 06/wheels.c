...
void LineFollow() {
    ...
    if(stateCounter == 3) {
        if(Drive_Path(LCIRC_RIGHT, LCIRC_LEFT, 1, 1, 5)) stateCounter = 0;
    }

    if(stateCounter == 4) {
        if(Drive_Path(RCIRC_RIGHT, RCIRC_LEFT, 1, 1, 5)) stateCounter = 0;
    }

    if(stateCounter == 5) {
        if(Drive_Path(STRAIGHT_RIGHT, STRAIGHT_LEFT, 1, 1, 5)) stateCounter = 0;
